...
//{
//    ///<summary>
//    /// A very thin wrapper around the KeyListener that provides everything the KeyListener does but adds the ability to 
//    /// add and hotswap HotKeySets in order to build a HotKey system around a Hooker.
//    ///</summary>
//    internal class HotKeySetsListener : KeyListener
//    {
...
//        ///<remarks>Hooks are not active after instantiation. You need to use either <see cref="BaseListener.Enabled"/> property or call <see cref="BaseListener.Start"/> method.</remarks>
